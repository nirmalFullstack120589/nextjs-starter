...
export const embeddedAssetBlockNode = (id: string) =>
  embeddedNode('embedded-asset-block', id, false);
...
export const personMock = ({ text } = { text: 'Default person mock' }): RichTextProps =>
  blogMock({ text });
